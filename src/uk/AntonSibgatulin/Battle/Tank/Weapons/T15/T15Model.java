package uk.AntonSibgatulin.Battle.Tank.Weapons.T15;
...
public class T15Model extends Tanks implements ITank{
	public T15Model(String name,int maxShot,int minShot,long reload,int maxsplash,int minsplash,int speed,long maxDistance,Hull hull) {
	...
	public void fire(String str) {
	 ...
	 public Object clone()
        ...
        {
		   return (ITank)new T15Model( type, maxShot, minShot, reload, maxSplash, minSplash, (int)speed, (long)maxDistance, hull);
